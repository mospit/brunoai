...
class Settings(BaseSettings):
    ...
    # Third-party APIs
    instacart_api_key: Optional[str] = Field(default=None, description="Instacart API key")
    mem0_api_key: Optional[str] = Field(default=None, description="Mem0 API key")
    voxtral_api_key: Optional[str] = Field(default=None, description="Voxtral API key for STT")
